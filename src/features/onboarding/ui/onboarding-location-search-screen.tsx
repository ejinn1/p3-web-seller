...
function RecentLocations({
  ...
  return (
    <div className="mt-6">
      <h2 className="text-sm font-semibold tracking-[-0.28px]">최근 검색</h2>
      {locations.length ? (
        <ul className="mt-2">
          {locations.map((location) => (
            <li className="flex items-start gap-2 py-2" key={location.address}>
              <button
                ...
                type="button"
              >
                <span className="block truncate text-sm leading-5 font-medium tracking-[-0.28px]">
                  {location.address}
                </span>
        ...
        return (
          <li key={`${address}-${item.zipCode}`}>
            <button
              ...
              type="button"
            >
              <span className="text-sm leading-5 font-medium tracking-[-0.28px]">
                {address}
              </span>
