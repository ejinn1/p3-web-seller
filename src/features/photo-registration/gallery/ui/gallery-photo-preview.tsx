...
export function GalleryPhotoPreview({
  ...
  return (
    <button
      ...
      className={`relative aspect-square min-w-0 touch-none overflow-hidden rounded-seller-sm bg-surface-subtle shadow-[0_1px_3px_0_rgb(0_0_0_/_0.06),0_1px_2px_0_rgb(0_0_0_/_0.04)] ${isDragging ? "z-10 scale-95 opacity-70" : ""}`}
      onClick={onClick}
      {...sortableItemProps}
      type="button"
    >
